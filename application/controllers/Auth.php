...
class Auth extends CI_Controller
{
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    redirect('user/profile'); //redirect ke halaman user
                } else {
    ...
    public function register()
    {
        ...
        $this->form_validation->set_rules('no_hp', 'Nomor HP', 'required|numeric|regex_match[/^\d{10,13}$/]|is_unique[user.no_hp]', [
            'is_unique' => 'This number has already registered in our system',
        ]);
