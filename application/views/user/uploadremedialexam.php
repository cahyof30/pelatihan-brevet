...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <?php if ($this->session->userdata('role_id') == 2) { ?>
            <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('user/uploadRemedialExam'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row mt-3">
                    ...
                    <?php
                    if (isset($users['remedialexam_file'])) { ?>
                        <input type="hidden" name="old_ans" id="old_ans" value="<?= $users['remedialexam_file']; ?>">

                    <?php } ?>

                    <div class="col-sm-10">
                        <input type="file" class="" name="remedialexam_file" id="remedialexam_file">
